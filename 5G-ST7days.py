...
# Embedded file name: /storage/emulated/0/5G-ST7days.py
...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> 5G-SPAMMER-TEAM <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook  -> Kausar Ahamed \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> 5G-SPAMMER-TEAM <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;96mAUTHOR  : MR-KAUSAR'
    print '\x1b[1;96mFACEBOOK  : 5G-SPAMMER-TEAM'
    print '\x1b[1;96mGITHUB  : github.com/5gspammingteam'
    print ''
    print 50* '-'
    print '\x1b[1;92m--------------------------------------------------'
    print
...
def action():
    ...
    os.system('python2 5G-ST7days.py')


if __name__ == '__main__':
    menu()
# okay decompiling 5G-ST7days.pyc
